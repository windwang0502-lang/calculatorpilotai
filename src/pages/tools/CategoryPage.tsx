...
export default function CategoryPage() {
  ...
  const allTools = [
    ...
    { title: 'Compound Interest Calculator', path: '/tools/finance/compound-interest-calculator', cat: 'finance' },
    ...
    { title: 'Calorie Calculator', path: '/tools/health/calorie-calculator', cat: 'health' },
    ...
    { title: 'Work Hours Calculator', path: '/tools/time/work-hours-calculator', cat: 'time' },
    ...
    { title: 'Token Calculator', path: '/tools/ai/token-calculator', cat: 'ai' },
