          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
              <div className="p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl text-center min-w-0">
                ...
                <div className={`${getResultTextSize(formatCurrency(result.currentPayment))} font-mono font-bold tabular-nums leading-none overflow-wrap-anywhere`}>{formatCurrency(result.currentPayment)}</div>
              </div>
              <div className="p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl text-center min-w-0">
                <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest block mb-2">New Payment</span>
                <div className={`${getResultTextSize(formatCurrency(result.newPayment))} font-mono font-bold text-emerald-600 tabular-nums leading-none overflow-wrap-anywhere`}>{formatCurrency(result.newPayment)}</div>
              </div>
              <div className="p-4 sm:p-5 bg-emerald-50 border border-emerald-200 rounded-xl text-center min-w-0">
                ...
                <div className={`${getResultTextSize(formatCurrency(result.monthlySavings))} font-mono font-bold text-emerald-600 tabular-nums leading-none overflow-wrap-anywhere`}>{formatCurrency(result.monthlySavings)}</div>
              </div>
              <div className="p-4 sm:p-5 bg-slate-50 border border-slate-200 rounded-xl text-center min-w-0">
              ...
              <div className="p-4 sm:p-5 bg-primary/5 border border-primary/20 rounded-xl text-center min-w-0 sm:col-span-2 lg:col-span-1">
                ...
                <div className={`${getResultTextSize(formatCurrency(result.lifetimeSavings))} font-mono font-bold text-primary tabular-nums leading-none overflow-wrap-anywhere`}>{formatCurrency(result.lifetimeSavings)}</div>
              </div>
            </div>
