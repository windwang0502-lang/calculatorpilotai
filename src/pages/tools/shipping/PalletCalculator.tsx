...
export default function PalletCalculator() {
  ...
  return (
    <ToolLayout
      ...
      description="Calculate how many boxes fit on a pallet and optimize your shipping and storage planning."
    >
      ...
      <div className="space-y-8">
        ...
        {result && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="bg-gradient-to-r from-primary/80 to-primary text-white p-8 rounded-xl text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl text-center">
                <span className="text-xs font-bold text-primary uppercase tracking-widest block mb-2">Utilization</span>
                <div className="text-xl font-mono font-bold text-primary">{formatNumber(result.palletUtilization, { decimals: 1 })}%</div>
              </div>
            </div>
